...
object StartActivityUtil {
    ...
    private fun <T : Activity> Activity.startActivity(
        ...
        flag: List<Int> = listOf(Intent.FLAG_ACTIVITY_SINGLE_TOP),
    ) {
        startActivity(
            Intent(
                /* packageContext = */
    ...
    /**
     * @author junsuPark
     * default public startActivity function, which lets context activity maintain single activity.
     */
    fun <T : Activity> Activity.startActivity(
        ...
        startActivity(
            context = context,
            to = to,
            flag = listOf(Intent.FLAG_ACTIVITY_SINGLE_TOP),
        )
    }
    ...
    fun <T : Activity> Activity.startActivityRemovingBackStack(
        ...
        startActivityFinishingCurrentActivity(
            context = context,
            to = to,
            flag = listOf(Intent.FLAG_ACTIVITY_CLEAR_TASK, Intent.FLAG_ACTIVITY_NEW_TASK),
        )
    }
}
